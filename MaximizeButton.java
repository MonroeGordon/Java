...
/**
 * MaximizeButton creates and controls the maximize button at the top right of the window. This button causes the window to be maximized or restored to its previous size.
 * @author Monroe Gordon
 * @since 5/28/2022
 */
public class MaximizeButton extends JButton implements MouseListener {

	/** MaximizeButton serial version ID value. */
	private static final long serialVersionUID = -7790390600464041763L;
	
	/** Maximize button height value. */
	public static final int BUTTON_HEIGHT = 25 - ChessFrame.FRAME_BORDER_SIZE;
	/** Maximize button width value. */
	...
	/**
	 * Default constructor for the MaximizeButton that creates the maximize button.
	 */
